...
import static com.yq.wx.wxpay.sdk.WXPayConstants.USER_AGENT;
/**
 * @Author : Yanqiang
 * @Date : 2019-08-06
 * @Description : 微信请求工具
...
public class WXPayRequest {
    ...
    private String requestOnce(final String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert) throws Exception {
        ...
        System.out.println("请求微信接口："+url);
        HttpPost httpPost = new HttpPost(url);

        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(readTimeoutMs).setConnectTimeout(connectTimeoutMs).build();
        httpPost.setConfig(requestConfig);
        System.out.println("请求前的参数打印：" + data);
     ...
     * @Author : Yanqiang
     * @Date : 2019/4/1
     * @Param : [urlSuffix, uuid, data, connectTimeoutMs, readTimeoutMs, useCert, autoReport]
     * @Description : 微信退款请求调用此接口
     */
